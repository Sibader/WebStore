...
<%@ page import ="com.duo.* ,entity.Items" %>
<%
  ...
  <head>
	...
	function selflog_show(id)
      { 
         ...
         J.dialog.get({id: 'haoyue_creat',title: '购物成功',
      ...
      <table width="750" height="60" cellpadding="0" cellspacing="0"
       ...
       <tr>      
            <% 
              ...
              //强制转换，获取传来的id值
              Items items=itemDao.getItemsById(Integer.parseInt(request.getParameter("id")));
            ...
            %>
                <td width="70%" valign="top">
                  <table>
                    <tr>
                      <td rowspan="4"><img src="images/<%=items.getPicture()%>" width="300" height="240"/></td>
                    </tr>
                    <tr>
                 ...
                 <div id="cart">
                   ...
                   <a href="javascript:selflog_show(<%=items.getId()%>)">
          ...
          <td width="30%" bgcolor="#EEE" align="center">
             ...
             <!-- 循环开始 -->
             <% 
                ArrayList<Items> itemlist = itemDao.getItemsList(list);
             ...
             <div>
               <dl>
                <dt>
                  <a href="storeInformatica.jsp?id=<%=i.getId()%>"><img src="images/<%=i.getPicture() %>" width="120" height="90" border="1"/></a>
                </dt>
